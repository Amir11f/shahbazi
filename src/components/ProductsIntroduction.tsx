...
export default function ProductsIntroduction() {
  return (
    <div className="flex flex-col items-center font-cursive gap-4 sm:gap-6 xl:gap-7 ">
      ...
      <button className="w-[135px] h-[43px] border-[#DFDFDF] border-[1px] mt-[154px] rounded-lg sm:rounded-xl sm:w-[246px] sm:h-[81px] sm:mt-[180px] flex flex-row gap-5 items-center justify-center sm:gap-11 top-0  hover:bg-golden transition duration-100">
