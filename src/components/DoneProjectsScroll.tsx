...
export default function DoneProjectsScroll() {
  return (
    <div className="flex flex-row gap-4 overflow-x-auto whitespace-nowrap xl:gap-11 xl:mt-20 mb-15 xl:mb-20">
      {doneProjects.map((item) => (
        ...
        >
          <div className="w-[31px] h-[31px] bg-[#F6F6F6] mr-4 sm:h-[42px] sm:w-[42px] xl:w-[70px] xl:h-[70px] flex items-center justify-center">
            <Telescope className="w-5.5 h-5.5 sm:w-7.5 sm:h-7.5 xl:w-12 xl:h-12 hover:text-golden" />
          </div>
