...
export default function DoneProjectsGrid() {
  return (
    <div className="flex flex-col items-center font-cursive mb-40 xl:mb-1">
      <div className="grid grid-cols-3 gap-1 sm:gap-2 xl:gap-3 w-full ">
        ...
        <div className="grid grid-rows-[3fr_6fr_2fr_2fr] gap-1 sm:gap-2 xl:gap-3 h-[416px] sm:h-[731px] xl:h-[1257px]">
          {instagremLike.slice(0, 4).map((item) => (
            <ProjectCard key={crypto.randomUUID()} item={item} />
          ))}
        </div>
      ...
      <div className="w-[110px] h-9 border-[1px] border-[#33383C] rounded-lg  mt-7.5 flex flex-row-reverse items-center justify-center gap-2 sm:w-[130px] sm:h-11 sm:gap-3 sm:mt-12 xl:w-[148px] xl:h-[50px] xl:relative xl:-top-40 hover:text-golden cursor-pointer hover:border-golden">
