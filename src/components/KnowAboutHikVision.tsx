...
export default function KnowAboutHikVision() {
  return (
    <div className="flex flex-col font-cursive items-center bg-[#F6F6F6] mt-10 pt-10 sm:mt-20 sm:pt-20 xl:mt-30 xl:pt-30">
      ...
      <div className="w-[325px]  flex flex-col items-center text-end sm:w-[432px] xl:w-full xl:flex-row-reverse xl:justify-center">
        <div className="flex flex-col items-start xl:w-[432px]">
          <p className="text-2xl/11 font-bold sm:text-end sm:text-[32px] xl:text-4xl xl:w-[432px]">
            نکات دانستی در مورد دوربین های هایک ویژن
          </p>
          ...
          <div className="w-[325px] h-10 rounded-lg bg-golden mt-8 mb-11 sm:w-[432px] sm:h-[40px] xl:w-[148px] xl:self-end flex flex-row-reverse items-center justify-center gap-2 cursor-pointer hover:bg-hover transition duration-100">
            <p className="text-sm text-white block">کمتر</p>
            <Vector
              className="w-3.5 h-3.5 rotate-270  font-bold
              "
              stroke="white"
              fill="red"
            />
        ...
        <Image
          ...
          width={274}
          height={274}
          className="sm:w-[391px] sm:h-[362px] xl:w-[660px] xl:h-[500px] bg-[#F6F6F6]"
        />
      </div>
    </div>
  );
